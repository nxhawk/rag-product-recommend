...
| Tag | Mô tả | Ví dụ |
| --- | ----- | ----- |
| `main` | Commit mới nhất trên `main` | `ghcr.io/nxhawk/techscout-rag-recommend:main` |
| `v*.*.*` | Bản release theo semantic version | `ghcr.io/nxhawk/techscout-rag-recommend:v1.0.0` |
| `v*.*` | Major.minor (rolling) | `ghcr.io/nxhawk/techscout-rag-recommend:v1.0` |
| `<sha>` | Commit SHA cụ thể | `ghcr.io/nxhawk/techscout-rag-recommend:a1b2c3d` |
